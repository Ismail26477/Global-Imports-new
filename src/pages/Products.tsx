    ...
    <div className="min-h-screen bg-background">
            ...
            {categories.map((category, index) => (
              ...
              >
                <HoverCard
                  ...
                  shadowOnHover="lg"
                  translateY={-15}
                  className="group cursor-pointer overflow-hidden rounded-2xl bg-white shadow-soft border border-transparent hover:border-gold/20"
                >
                  <div
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-navy to-navy-dark">
        <div className="container mx-auto px-4 text-center">
          ...
          <AnimationWrapper type="scaleIn" delay={0.3}>
